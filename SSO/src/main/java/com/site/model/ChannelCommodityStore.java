...
public class ChannelCommodityStore {
	...
	public String toString() {
		return "ChannelCommodityStore [ChannelCode=" + ChannelCode + ", ChannelStoreId=" + ChannelStoreId
				+ ", StoreCode=" + StoreCode + ", CommodityCode=" + CommodityCode + ", isShelf=" + isShelf
				+ ", disabled=" + disabled + ", SalePrice=" + SalePrice + ", OriginalPrice=" + OriginalPrice
				+ ", OutCommodityCode=" + OutCommodityCode + "]";
	}
